...
other_urlpatterns = [
    ...
    path("remove-learning-check/<uuid:learning_id>/", views.check_delete_learning_view, name="remove-learning-check"),
    path("remove-learning/<uuid:learning_id>/", views.delete_learning_view, name="remove-learning"),
