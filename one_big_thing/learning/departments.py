...
department_tuples = (
    ...
    ("british-technology-investments-ltd", "British Technology Investments Ltd"),
    ...
    ("electricity-settlements-company", "Electricity Settlements Company (ESC)"),
    ...
    ("low-carbon-contracts-company", "Low Carbon Contracts Company (LCCC)"),
    ...
    ("national-nuclear-laboratory", "National Nuclear Laboratory (NNL)"),
    ...
    ("national-protective-security-authority", "National Protective Security Authority (NPSA)"),
    ...
    ("northern-ireland-policing-board", "Northern Ireland Policing Board (NIPB)"),
    ...
    ("office-for-local-government", "Office for Local Government (Oflog)"),
    ...
    ("office-for-the-independent-examiner-of-complaints", "Office for the Independent Examiner of Complaints (IEC)"),
    ...
    ("project-delivery-function", "Project Delivery Function"),
    ...
    ("science-advisory-committees", "Science Advisory Committees (SACs)"),
    ...
    ("uk-shared-business-services-ltd", "UK Shared Business Services Ltd (UKSBS)"),
