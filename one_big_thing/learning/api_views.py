...
SELECT
    ...
    count(CASE WHEN u._has_completed_pre_survey THEN 1 END) as completed_first_evaluation,
    count(CASE WHEN u._has_completed_post_survey THEN 1 END) as completed_second_evaluation,
