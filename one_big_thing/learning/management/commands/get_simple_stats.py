...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        self.stdout.write(str(number_of_sign_ups))
        self.stdout.write(str(completed_first_evaluation))
        self.stdout.write(str(completed_second_evaluation))
        self.stdout.write(str(completed_1_hours_of_learning))
        self.stdout.write(str(completed_2_hours_of_learning))
        self.stdout.write(str(completed_3_hours_of_learning))
        self.stdout.write(str(completed_4_hours_of_learning))
        self.stdout.write(str(completed_5_hours_of_learning))
        self.stdout.write(str(completed_6_hours_of_learning))
        self.stdout.write(str(completed_7_plus_hours_of_learning))
        self.stdout.write(str(total_time_completed))
        self.stdout.write(str(number_of_completed_sign_ups))
